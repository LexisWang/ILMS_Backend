#define NGX_CONFIGURE " --add-module=../nginx-upload-module-2.3.0 --prefix=/usr/local/nginx --conf-path=/usr/local/nginx/conf/nginx.conf --pid-path=/usr/local/nginx/nginx.pid --with-http_ssl_module --with-http_gzip_static_module"

#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 9.3.0 (Alpine 9.3.0) "
#endif
